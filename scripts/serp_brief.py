...
BRIEF_PROMPT_TEMPLATE = """Tu es un strategiste SEO et GEO (Generative Engine Optimization) specialise en niche : reconversion professionnelle, impact IA sur les metiers, formations IA, economie du travail.
...
REQUETE : "{keyword}"
MARCHE CIBLE : France, salaries et freelances en reconversion ou curieux de l'impact IA sur leur metier
NOTRE POSITIONNEMENT : Adapte-toi, media francophone sur la reconversion et l'adaptation au monde du travail transforme par l'IA, zero bullshit, source verifiee
