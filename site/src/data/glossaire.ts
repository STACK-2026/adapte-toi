...
export const glossaire: Record<string, GlossaireEntry> = {
  ...
  "prompt": {
    ...
    externalSource: { url: "https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview", label: "Anthropic" },
    category: "ia",
  },
  "prompt engineering": {
  ...
  "agent ia": {
    ...
    externalSource: { url: "https://www.anthropic.com/news/claude-3-5-sonnet", label: "Anthropic agents" },
    category: "ia",
  ...
  "soft skills": {
    ...
    externalSource: { url: "https://fr.wikipedia.org/wiki/Savoir-%C3%AAtre", label: "Wikipedia" },
    category: "emploi",
  },
  "hard skills": {
  ...
  "bts": {
    ...
    externalSource: { url: "https://www.onisep.fr/formation/apres-le-bac-les-etudes-superieures/les-principales-filieres-d-etudes-superieures/les-bts-brevet-de-technicien-superieur", label: "ONISEP" },
    category: "emploi",
  },
  "but": {
    ...
    externalSource: { url: "https://www.onisep.fr/formation/apres-le-bac-les-etudes-superieures/les-principales-filieres-d-etudes-superieures/les-but-bachelors-universitaires-de-technologie", label: "ONISEP" },
    category: "emploi",
  },
  "ca": {
  ...
  "kpi": {
    ...
    externalSource: { url: "https://fr.wikipedia.org/wiki/Indicateur_cl%C3%A9_de_performance", label: "Wikipedia" },
    category: "business",
  ...
  "okr": {
    ...
    externalSource: { url: "https://fr.wikipedia.org/wiki/M%C3%A9thode_OKR", label: "Wikipedia" },
    category: "business",
  },
  "ceo": {
  ...
  "cdi": {
    ...
    internalLink: { href: "/actu/ipsos-47-pourcent-actifs-reconversion-ia", label: "Décryptage Ipsos reconversion" },
    externalSource: { url: "https://www.service-public.fr/particuliers/vosdroits/F10705", label: "service-public.fr" },
    category: "emploi",
  },
  "cdd": {
