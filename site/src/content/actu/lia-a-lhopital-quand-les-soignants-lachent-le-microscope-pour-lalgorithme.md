...
keyQuote:
  ...
  context: "À propos de l'urgence des AVC et des limites de l'analyse manuelle des IRM avant l'IA"
tldr:
  - "L'IA divise par 10 le temps de diagnostic des AVC au CHU de Lille, sauvant des milliers de neurones par patient."
  - "Les métiers de la santé se recentrent sur l'humain : moins de tâches répétitives, plus d'interprétation et de relation patient."
  - "Problème : 80% des hôpitaux français n'ont pas les moyens d'investir dans ces technologies, creusant les inégalités territoriales."
  - "Opportunité : les soignants qui maîtrisent ces outils voient leur valeur marché exploser, avec des salaires +20% dans les CHU équipés."
sources:
  - title: "« Avant on ramenait des plateaux entiers de lames en verre qu'on analysait au microscope » : comment l'IA transforme le travail des soignants"
    url: https://www.lefigaro.fr/conjoncture/avant-on-ramenait-des-plateaux-entiers-de-lames-en-verre-qu-on-analysait-au-microscope-comment-l-ia-transforme-le-travail-des-soignants-20260606
    outlet: "Le Figaro Éco"
    date: 2026-06-06
  - title: "L'intelligence artificielle dans les hôpitaux français : état des lieux 2025"
    url: https://drees.solidarites-sante.gouv.fr/publications/etudes-et-resultats/l-intelligence-artificielle-dans-les-hopitaux-francais-etat-des-lieux-2025
    outlet: "DREES"
    date: 2025-11-15
relatedMetiers:
  - "infirmier-ia"
  - "data-analyst-ia"
  - "medecin-generaliste-ia"
relatedGuides:
...
relatedOutils:
  ...
  - "chatgpt"
  - "perplexity"
imageAlt: "Un radiologue compare une IRM traditionnelle avec une analyse IA sur écran tactile dans un hôpital moderne"
keywords: "IA santé, CHU Lille, radiologie IA, anatomie pathologique, AVC, thrombectomie, reconversion médicale, compétences IA soignants, inégalités territoriales santé"
...
> *Pr Kuchcinski, chef du service de neuroradiologie au CHU de Lille*
...
- **60 jours** : Suis une formation gratuite sur l'IA médicale. Notre [guide](/guides/se-former-ia-gratuitement) liste des MOOCs certifiants.
- **90 jours** : Postule dans un CHU équipé en IA. Consulte notre [fiche métier infirmier·ère IA](/metiers/infirmier-ia).

**Tu es médecin ou radiologue**
- **30 jours** : Teste des outils comme [Aidoc](https://www.aidoc.com) ou [PathAI](https://www.pathai.com) en démo.
- **60 jours** : Utilise [ChatGPT](/outils/chatgpt) ou [Claude](/outils/claude) pour générer des comptes rendus.
- **90 jours** : Négocie une augmentation avec ton employeur. Notre [guide](/guides/negocier-salaire-competences-ia) t'aide. Sinon, envisage une mobilité vers un CHU mieux équipé.

**Tu es étudiant·e en santé**
- **30 jours** : Choisis une spécialité compatible avec l'IA (radiologie, urgences).
- **60 jours** : Apprends le prompt engineering. Notre [guide](/guides/prompt-engineering-debutant) est utile.
...
- **60 jours** : Forme-toi via [Coursera](https://www.coursera.org) ou [OpenClassrooms](https://openclassrooms.com). Certaines formations sont éligibles au CPF.
