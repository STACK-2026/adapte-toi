...
keyQuote:
  ...
  context: "Déclaration liminaire du 18 juin 2026, premier groupe de travail de négociation de l'accord cadre IA dans la fonction publique."
tldr:
  - "Le ministre David Amiel a ouvert le 18 juin 2026 la négociation d'un accord cadre IA pour les trois versants de la fonction publique, avec un accord visé en septembre 2026."
  - "Le gouvernement a déjà annoncé le 16 juin un assistant conversationnel pour environ 1 million d'agents de l'Etat, avant même l'ouverture de la table de négociation."
  - "La CGT exige zéro licenciement lié aux gains IA, zéro pilotage individuel des carrières par algorithme et un registre obligatoire des outils déployés."
  - "France Travail illustre la zone grise : 515 équivalents temps plein supprimés en 2026, 800 redéployés d'ici 2027, sur 54 000 agents au total."
sources:
  - title: "Groupe de travail de négociation de l'accord cadre intelligence artificielle dans la Fonction publique du 18 juin 2026"
    url: "https://www.cgtetat.fr/vie-des-personnels/sante-travail/intelligence-artificielle/article/groupe-de-travail-de-negociation-de-l-accord-cadre-intelligence-artificielle"
    outlet: "CGT Fonction publique"
    date: 2026-06-18
  - title: "IA dans la fonction publique : l'Etat présente un projet clé en main aux syndicats qui redoutent une faible marge de négociation"
    url: "https://acteurspublics.fr/articles/dans-le-dialogue-social-les-negociations-autour-de-lia-souvrent-dans-un-climat-tendu/"
    outlet: "Acteurs Publics"
    date: 2026-06-19
  - title: "Fonction publique : un assistant IA pour tous les agents de l'Etat"
    url: "https://www.boursorama.com/actualite-economique/actualites/fonction-publique-un-assistant-ia-pour-tous-les-agents-de-l-etat-bda07ad9d03ad19c94a85d3be764950b"
    outlet: "Boursorama"
    date: 2026-06-16
  - title: "Négociation IA dans la fonction publique : la CFDT pose ses conditions"
    url: "https://www.cfdt-ufetam.org/negociation-ia-dans-la-fonction-publique-la-cfdt-pose-ses-conditions/"
    outlet: "CFDT UFETAM"
    date: 2026-06-17
  - title: "Chez France Travail, l'IA s'installe, pour les agents et les demandeurs d'emploi"
    url: "https://www.france24.com/fr/info-en-continu/20260619-chez-france-travail-l-ia-s-installe-pour-les-agents-et-les-demandeurs-d-emploi"
    outlet: "France 24"
    date: 2026-06-19
  - title: "Statistiques sur l'emploi public"
...
relatedOutils:
  ...
  - "chatgpt"
  - "perplexity"
keywords: "accord cadre IA fonction publique, David Amiel négociation IA, IA agents Etat 2026, CGT IA fonction publique, CFDT négociation IA, assistant IA 1 million fonctionnaires, France Travail IA, IA emploi public"
schemaFaq: true
lastReviewed: 2026-06-25
reviewedBy: "Rédaction Adapte-toi"
draft: false
image: "https://images.unsplash.com/photo-1541872703-74c5e44368f5?w=1200&h=630&fit=crop&q=80&auto=format"
imageAlt: "Vue d'un bureau de l'administration française avec un poste de travail allumé."
---
...
1. **L'évaluation individuelle par IA.** Le gouvernement n'a pas exclu, dans son projet initial, l'usage de l'IA pour analyser la production des agents. La CGT et la CFDT exigent une interdiction explicite. Si le principe passe dans la fonction publique, il deviendra plus difficile à refuser dans le privé.
2. **La requalification post-IA.** Les outils annoncés vont automatiser une partie des tâches administratives, RH et de saisie. La question n'est pas de savoir si les postes vont changer, mais qui paie la formation et qui décide des reconversions. Notre [guide reconversion IA](/guides/reconversion-ia-guide-complet) détaille les mécanismes existants.
3. **La transparence des outils déployés.** La CFDT réclame un registre obligatoire des outils IA en service, inspiré du règlement européen IA. Sans ce registre, impossible de savoir ce qui est testé sur les agents et les usagers. Notre [synthèse réglementation IA Europe](/guides/ia-europe-reglementation) explique le mécanisme côté privé.
...
Les outils en production chez France Travail sont déjà nombreux. ChatFT pour l'accueil de premier niveau, ChatFT Ecoute pour la transcription des entretiens, MatchFT pour le rapprochement offre demande. Ces outils correspondent aux métiers les plus exposés du référentiel France Travail, en particulier les postes de [chargé de clientèle](/metiers/charge-clientele-ia) et d'[assistant administratif](/metiers/assistant-administratif-ia). Pour suivre la cartographie complète, notre [guide IA emploi chiffres clés](/guides/ia-emploi-chiffres-cles) recense les études disponibles.
...
- **Métiers administratifs et de gestion.** Saisie, instruction de dossiers, courrier. L'automatisation visée concerne environ 40% des tâches selon les rapports internes DGAFP cités par Acteurs Publics. Voir notre fiche [assistant administratif IA](/metiers/assistant-administratif-ia).
- **Métiers d'accueil et d'orientation.** Premier niveau de réponse, FAQ, qualification de demande. C'est le cas type ChatFT. Tendance similaire dans le privé, voir notre fiche [chargé de clientèle IA](/metiers/charge-clientele-ia).
- **Métiers RH.** Pré sélection de candidatures, gestion de mobilité, formation. Notre fiche [RH recruteur IA](/metiers/rh-recruteur-ia) détaille les outils utilisés et les risques de biais.
- **Métiers d'analyse et de données.** Reporting, tableaux de bord, analyse statistique. La demande de profils [data analyst IA](/metiers/data-analyst-ia) explose dans l'administration.

Pour les agents concernés, la fenêtre utile est étroite. Notre [guide négocier ses compétences IA](/guides/negocier-salaire-competences-ia) recense les leviers à activer lors de l'entretien annuel.
...
- Forme toi en autonomie. Les bases tiennent en quelques heures avec [Claude](/outils/claude), [ChatGPT](/outils/chatgpt) ou [Perplexity](/outils/perplexity). Cible le prompt engineering et la vérification factuelle.
...
- Cartographie les tâches automatisables dans ton service avant le déploiement, pas après. Notre [guide chiffres IA emploi](/guides/ia-emploi-chiffres-cles) donne la méthodologie.
...
Plusieurs voies coexistent. Les plateformes internes des ministères, le CNFPT pour la territoriale, le compte personnel de formation pour les démarches individuelles. En complément, des outils gratuits permettent une mise à niveau rapide. Voir notre [guide se former à l'IA gratuitement](/guides/se-former-ia-gratuitement) et notre [guide financer une formation IA via le CPF](/guides/financer-formation-ia-cpf).

## Sources

- [Déclaration liminaire CGT Fonction publique, groupe de travail accord cadre IA, 18 juin 2026](https://www.cgtetat.fr/vie-des-personnels/sante-travail/intelligence-artificielle/article/groupe-de-travail-de-negociation-de-l-accord-cadre-intelligence-artificielle)
- [Acteurs Publics, climat des négociations IA fonction publique, 19 juin 2026](https://acteurspublics.fr/articles/dans-le-dialogue-social-les-negociations-autour-de-lia-souvrent-dans-un-climat-tendu/)
- [Boursorama, assistant IA pour tous les agents de l'Etat, 16 juin 2026](https://www.boursorama.com/actualite-economique/actualites/fonction-publique-un-assistant-ia-pour-tous-les-agents-de-l-etat-bda07ad9d03ad19c94a85d3be764950b)
- [CFDT UFETAM, conditions de la négociation IA, 17 juin 2026](https://www.cfdt-ufetam.org/negociation-ia-dans-la-fonction-publique-la-cfdt-pose-ses-conditions/)
- [France 24, France Travail et l'IA, 19 juin 2026](https://www.france24.com/fr/info-en-continu/20260619-chez-france-travail-l-ia-s-installe-pour-les-agents-et-les-demandeurs-d-emploi)
