---
title: "150 personnalités appellent au boycott de l'IA générative : et si c'était le début d'une résistance utile ?"
...
keyQuote:
  ...
  context: "Tribune publiée dans Le Monde le 18 juin 2026"
tldr:
  - "150 artistes, écrivains et intellectuels appellent au boycott de l'IA générative, craignant une marginalisation de l'humain et des dépendances cognitives."
  - "L'IA générative est déjà massivement adoptée par les jeunes, avec des risques réels sur leurs capacités à penser et créer sans assistance algorithmique."
  - "Ce boycott pourrait forcer les entreprises à repenser leur usage de l'IA, surtout dans les métiers créatifs et cognitifs."
  - "Pour toi, c'est l'occasion de questionner ta propre dépendance aux outils IA et de développer des compétences résilientes."
sources:
  - title: "Les robots affaibliront ses capacités cognitives et créeront de redoutables dépendances émotionnelles : un appel à boycotter l'IA générative lancé par des personnalités"
    url: "https://www.bfmtv.com/tech/les-robots-affaibliront-ses-capacites-cognitives-et-creeront-de-redoutables-dependances-emotionnelles-un-appel-a-boycotter-l-ia-generative-lance-par-des-personnalites_AD-202606180649.html"
    outlet: "BFM Tech"
    date: 2026-06-18
  - title: "Baromètre du numérique 2026"
...
relatedOutils:
  ...
  - "claude"
  - "perplexity"
imageAlt: "Une main humaine tenant un pinceau face à un écran affichant un robot, symbolisant le conflit entre création humaine et IA générative."
keywords: "IA générative, boycott, dépendance cognitive, métiers créatifs, résistance humaine, Arcom, Le Monde, ChatGPT, compétences résilientes"
...
> *Les 150 signataires de la tribune, Le Monde, 18 juin 2026*
...
- **À 30 jours** : Fais un audit de ta dépendance aux outils IA. Combien de % de ton travail est généré ou corrigé par ChatGPT, MidJourney, etc. ? Si c'est plus de 30%, réduis la voilure. Utilise notre [guide pour automatiser ton travail sans perdre ton âme](/guides/automatiser-travail-ia).
...
- **À 90 jours** : Propose à ton employeur ou à tes clients une offre "sans IA". Beaucoup sont prêts à payer plus pour du vrai travail humain. Inspire-toi de notre fiche [métier graphiste IA](/metiers/graphiste-ia) pour argumenter.
...
- **À 60 jours** : Trouve un mentor dans ton domaine (un prof, un pro expérimenté) et demande-lui de t'apprendre à penser sans IA. Les compétences résilientes (rédaction, analyse, créativité) seront ton meilleur atout. Consulte notre [guide pour te former gratuitement à l'IA… sans en devenir dépendant](/guides/se-former-ia-gratuitement).
- **À 90 jours** : Participe à un atelier d'écriture ou de dessin manuel. Rien de tel pour retrouver le plaisir de créer sans algorithme. Et si tu veux aller plus loin, explore les [métiers de l'enseignement avec l'IA](/metiers/enseignant-ia), où la transmission humaine reste centrale.

**Tu es manager ou chef d'entreprise**
- **À 30 jours** : Interroge tes équipes sur leur usage de l'IA. Qui l'utilise ? Pour quoi faire ? À quelle fréquence ? Tu risques d'avoir des surprises. Utilise notre [outil Claude](/outils/claude) pour analyser les réponses (ironie assumée).
- **À 60 jours** : Mets en place une charte IA dans ton entreprise. Limite son usage dans les métiers créatifs et cognitifs, et forme tes équipes aux risques de dépendance. Inspire-toi de notre [guide sur la reconversion IA](/guides/reconversion-ia-guide-complet).
...
- **À 90 jours** : Propose à ton école ou ta mairie d'intégrer un module "pensée critique face à l'IA" dans les programmes. Les compétences humaines (esprit critique, créativité, empathie) seront cruciales pour les métiers de demain. Consulte notre fiche [métier enseignant IA](/metiers/enseignant-ia) pour des pistes.
