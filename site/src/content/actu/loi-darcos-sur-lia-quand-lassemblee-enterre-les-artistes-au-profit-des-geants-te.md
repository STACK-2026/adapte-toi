---
title: "Loi Darcos IA 2026 : artistes perdent, tech gagnent"
...
keyQuote:
  ...
  context: "Réaction à l'échec de la loi Darcos le 11 juin 2026 à l'Assemblée nationale"
tldr:
  - "Une loi transpartisane pour protéger les artistes du moissonnage par l'IA a été bloquée par 100 amendements macronistes, sous pression des lobbys tech comme Mistral AI."
  - "Le texte prévoyait d'inverser la charge de la preuve : les géants de l'IA auraient dû prouver qu'ils n'utilisaient pas les œuvres des créateurs, et les rémunérer en conséquence."
  - "81 organisations culturelles et 25 000 créateurs soutenaient la loi, mais le gouvernement a cédé au chantage à l'innovation des entreprises comme OpenAI ou Google."
  - "Sans cadre légal, les métiers artistiques (graphistes, musiciens, écrivains) restent exposés à l'exploitation gratuite de leur travail par les LLM."
sources:
  - title: "Un jour de deuil: le monde de la culture s'insurge après le renvoi d'un texte visant à protéger les artistes du moissonnage de leur travail par les géants de l'IA"
    url: "https://www.bfmtv.com/tech/intelligence-artificielle/un-jour-de-deuil-le-monde-de-la-culture-s-insurge-apres-le-renvoi-d-un-texte-visant-a-proteger-les-artistes-du-moissonnage-de-leur-travail-par-les-geants-de-l-ia_AD-202606120664.html"
    outlet: "BFM Tech"
    date: 2026-06-12
  - title: "Loi Darcos : pourquoi le gouvernement a enterré la protection des œuvres face à l'IA"
...
relatedOutils:
  ...
  - "midjourney"
  - "notion-ai"
imageAlt: "Manifestation d'artistes devant l'Assemblée nationale le 11 juin 2026, avec des pancartes 'Mon travail n'est pas une donnée gratuite' et 'IA = vol organisé'"
keywords: "loi Darcos, IA, moissonnage, artistes, Mistral AI, OpenAI, droit d'auteur, lobbying, culture, emploi créatif, rémunération, transparence, AI Act, Arthur Mensch"
...
- **100 amendements** déposés par Renaissance pour bloquer la loi ([BFM Tech](https://www.bfmtv.com/tech/intelligence-artificielle/un-jour-de-deuil-le-monde-de-la-culture-s-insurge-apres-le-renvoi-d-un-texte-visant-a-proteger-les-artistes-du-moissonnage-de-leur-travail-par-les-geants-de-l-ia_AD-202606120664.html))
- **25 000 créateurs** et **81 organisations** soutenaient le texte (Sacem, Syndicat national de l'édition, etc.)
- **0 obligation de transparence** pour les entreprises d'IA dans l'AI Act ([Règlement (UE) 2024/1689](https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX%3A32024R1689))
- **30% de baisse** des commandes pour les photographes de presse depuis 2024 ([SNJ](https://www.snj.fr))
- **42% des graphistes freelances** ont vu leurs revenus baisser en 2025 ([INSEE](https://www.insee.fr))

## La citation qui résume tout
> *"La vraie question est simple : voulons-nous une IA fondée sur la transparence et le respect des règles, ou une IA qui se développe dans l'opacité au détriment des créateurs ?"*
> *Sacem*
...
- **60 jours** : Utilise [Glaze](https://glaze.cs.uchicago.edu) ou [Nightshade](https://nightshade.cs.uchicago.edu) pour protéger tes œuvres.
- **90 jours** : Diversifie tes revenus. Forme-toi au [prompt engineering](/guides/prompt-engineering-debutant) ou à la retouche d'images IA.
...
- **60 jours** : Automatise les tâches répétitives avec [Claude](/outils/claude) ou [Notion AI](/outils/notion-ai).
...
- **60 jours** : Forme-toi à la négociation salariale avec des compétences "anti-IA" ([guide](/guides/negocier-salaire-competences-ia)).
- **90 jours** : Propose un atelier sur les droits d'auteur et l'IA.

**Tu envisages une reconversion :**
- **30 jours** : Fais un bilan de tes compétences transférables ([outil](/outils/claude)).
