...
description: "Pendant deux ans, les plans sociaux évoquaient la 'réorganisation'. Depuis six mois, les CEO nomment explicitement l'IA comme cause. On a listé les annonces, chiffré l'ampleur, identifié les signaux pour la France."
date: 2026-04-09
category: "menace"
impactLevel: 4
author: "Léa Moreau"
keyQuote:
  ...
  context: "CEO Klarna, interview Bloomberg, février 2026"
tldr:
  - "Depuis fin 2024, les annonces de licenciements ou gels d'embauche liés à l'IA ont quitté le registre euphémisé. Klarna, IBM, Duolingo, Salesforce, Dropbox, UPS assument publiquement le lien."
  - "Estimation cumulée 2024-2026 : plus de 200 000 postes détruits ou non renouvelés dans les grandes entreprises mondiales avec mention explicite de l'IA comme cause."
  - "Les fonctions les plus touchées sont les mêmes partout : support client, back-office, rédaction, traduction, tests logiciels, développement junior."
  - "En France, les grands groupes restent prudents dans la communication, mais les mouvements internes (non-remplacements, plans de départ volontaire) sont déjà là et vont s'accélérer à partir de 2026."
sources:
  - title: "Klarna confirms AI-driven workforce reduction"
    url: "https://www.bloomberg.com"
    outlet: "Bloomberg"
    date: 2026-02-14
  - title: "IBM pauses hiring for back-office roles"
  ...
  - title: "The AI Layoffs Tracker"
    ...
    outlet: "Layoffs.fyi"
    date: 2026-04-01
  - title: "En France, le silence des grands groupes sur les licenciements IA"
...
**Deux.** Les métiers touchés sont toujours les mêmes : support client, back-office, rédaction, traduction, testing, développement junior, comptabilité niveau 1. Aucune surprise, c'est le même champ que ce qu'Anthropic a chiffré dans son [Economic Index](/actu/anthropic-economic-index-mars-2026-impact). La cohérence des chiffres entre rapports académiques, études d'éditeurs et annonces d'entreprises est frappante.
...
> *Sebastian Siemiatkowski, CEO Klarna, Bloomberg février 2026*
