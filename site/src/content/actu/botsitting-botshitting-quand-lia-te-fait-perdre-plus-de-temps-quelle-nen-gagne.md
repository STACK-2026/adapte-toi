---
title: "Botsitting, botshitting : quand l'IA te fait perdre plus de temps qu'elle n'en gagne"
...
keyQuote:
  ...
  context: "Extrait de l'étude 'Botsitting, botshitting, and the hidden human labor of AI at work'"
tldr:
  - "75% des pros du numérique gagnent 11h/semaine avec l'IA, mais 6,4h sont bouffées par du 'botsitting' (surveillance, correction, contexte)."
  - "69% avouent faire du 'botshitting' : livrer du travail généré par IA sans le vérifier, créant une chaîne de bullshit en entreprise."
  - "36% des sessions IA échouent, et 41% des utilisateurs livrent des résultats qu'ils ne comprennent pas. L'IA augmente la charge mentale, pas la productivité collective."
  - "Seuls 13% des employés estiment que leur boîte profite vraiment des gains individuels. L'IA optimise les tâches, pas les organisations."
sources:
  - title: "Botsitting, botshitting : quand l'IA au travail crée plus de travail qu'elle n'en supprime"
    url: "https://next.ink/242659/botsitting-botshitting-quand-lia-au-travail-cree-plus-de-travail-quelle-nen-supprime/"
    outlet: "Next.ink"
    date: 2026-06-18
  - title: "The Hidden Costs of AI at Work"
    url: "https://www.workai.institute/reports/hidden-costs-ai-work"
    outlet: "Work AI Institute"
    date: 2026-05-15
relatedMetiers:
  - "consultant-ia"
  - "chef-de-projet-ia"
...
relatedOutils:
  ...
  - "perplexity"
  - "cursor"
imageAlt: "Un employé épuisé devant trois écrans affichant des interfaces d'IA, avec des post-it 'Vérifier', 'Corriger', 'Contexte ?' collés partout."
keywords: "IA, productivité, botsitting, botshitting, charge mentale, automatisation, Work AI Institute, reconversion, compétences, numérique"
...
> *Work AI Institute, étude "Botsitting, botshitting, and the hidden human labor of AI at work"*
...
1. **Audit tes outils** : Liste les IA utilisées (ChatGPT, Copilot…). Note le temps passé à :
   ...
   - Gérer les échecs.
   Si >30% du temps, parle-en à ton N+1. Besoin de formation ou d'outil mieux adapté ?
2. **Stop au botshitting** : Avant de livrer un travail IA, demande-toi :
   ...
   - L'assumerais-je sans IA ?
   Si non, reprends le contrôle. Voir [guide automatisation sans bullshit](/guides/automatiser-travail-ia).
...
1. **Cartographie les usages IA** : Identifie qui utilise quoi et combien de temps. Si 60% de l'équipe fait du botsitting, restructure. Voir [fiche consultant IA](/metiers/consultant-ia).
2. **Crée un poste de "botsitter"** : Désigne une personne pour :
   - Former les équipes.
   - Vérifier les outputs critiques.
   - Documenter les erreurs.
3. **Interdis le botshitting** : Ajoute une clause : "Tout livrable IA doit être validé par un humain et documenté (prompt, vérifications)." Utilise [Claude](/outils/claude) ou [Perplexity](/outils/perplexity) pour des templates de vérification.

### Freelance ou indépendant·e
1. **Facture le botsitting** : Inclus le temps de supervision dans tes devis. Exemple : "Article IA : 2h génération + 1h vérification." Voir [guide négociation compétences IA](/guides/negocier-salaire-competences-ia).
2. **Limite les outils** : Choisis 1-2 outils max (ex : [ChatGPT](/outils/chatgpt) pour le texte). Maîtrise-les. Voir [guide prompt engineering](/guides/prompt-engineering-debutant).
...
1. **Forme-toi au botsitting** : Les compétences recherchées en 2026 : corriger les erreurs IA. Voir [guide reconversion IA](/guides/reconversion-ia-guide-complet).
2. **Évite les métiers 100% automatisables** : Oriente-toi vers la vérification, la contextualisation. Exemple : [data analyst IA](/metiers/data-analyst-ia).
3. **Apprends à détecter le botshitting** : Repère les signes :
   - Texte trop lisse.
   - Faits non sourcés.
   - Réponses évasives.
   Utilise [Perplexity](/outils/perplexity) pour vérifier.
