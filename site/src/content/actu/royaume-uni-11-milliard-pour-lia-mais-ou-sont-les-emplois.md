...
keyQuote:
  ...
  context: "Réaction à l'annonce du plan britannique sur l'IA lors de la London Tech Week 2026"
tldr:
  - "Le Royaume-Uni investit 1,1 milliard dans l'IA, mais 40% de cette somme était déjà promise. L'objectif ? Créer des 'champions britanniques' des puces IA, un marché dominé à 90% par TSMC (Taïwan) et Nvidia (USA)."
  - "20 millions pour cartographier l'impact de l'IA sur les emplois débutants : une goutte d'eau face aux 30% de métiers menacés d'automatisation d'ici 2030 (OCDE)."
  - "AMD et Nebius injectent 3,7 milliards dans des partenariats UK, mais ces fonds iront surtout à des puces Nvidia. L'emploi local ? Pas garanti."
  - "Le vrai débat : comment former 500 000 travailleurs d'ici 2027 quand les formations IA coûtent 15 000€/an et sont réservées aux ingénieurs ?"
sources:
  - title: "UK sets out AI infrastructure push at London Tech Week, how does it stack up?"
    url: "https://www.theguardian.com/technology/2026/jun/13/uk-ai-hardware-london-tech-week-investment-chips"
    outlet: "Guardian AI"
    date: 2026-06-13
  - title: "The impact of AI on jobs: Evidence from OECD countries"
    url: "https://www.oecd.org/employment/ai-jobs-report/"
    outlet: "OCDE"
    date: 2023-10-15
relatedMetiers:
  - "data-analyst-ia"
...
relatedOutils:
  ...
  - "chatgpt"
  - "perplexity"
imageAlt: "Un datacenter rempli de serveurs avec des drapeaux britanniques, symbolisant l'investissement britannique dans l'infrastructure IA."
keywords: "IA Royaume-Uni, emploi IA, puces semiconducteurs, reconversion professionnelle, formation IA, souveraineté technologique, Nvidia, TSMC, Arm Holdings, London Tech Week"
...
**1. Le Royaume-Uni mise sur l'IA pour créer des emplois, mais dépend de Taïwan et des États-Unis**
Le gouvernement parle de "souveraineté technologique", mais **TSMC et Nvidia contrôlent 90% du marché**. Le plan à 1,1 milliard est marginal face aux **20 milliards** nécessaires pour une usine TSMC. Résultat : les puces britanniques utiliseront du silicium étranger, créant surtout des emplois de maintenance.

**2. 20 millions pour "redessiner les rôles" : insuffisant face à l'urgence**
Le budget de **20 millions** pour adapter les emplois débutants représente **0,0018% du PIB**. La France a alloué **1,5 milliard** à son plan "IA et compétences". Pourtant, **30% des métiers britanniques** sont menacés par l'automatisation d'ici 2030 (OCDE). Avec 20 millions, on forme **1 300 personnes** sur 33 millions d'actifs.

**3. AMD et Nebius investissent 3,7 milliards... pour acheter des puces Nvidia**
Ces fonds serviront à acquérir des puces Nvidia pour des datacenters locaux. Les emplois créés concerneront la construction ou la maintenance, pas la R&D. Les partenariats avec Cambridge ou Imperial visent des chercheurs, pas des techniciens.

**4. Former 500 000 personnes d'ici 2027 : un défi impossible ?**
L'objectif est ambitieux. Les formations coûtent **10 000 à 25 000€** (ex : MSc en IA à Imperial College). **Qui peut se les offrir ?** Les ingénieurs, pas les caissiers ou infirmières. Sans formations accessibles, l'IA aggravera les inégalités.
...
- **Évalue les risques** avec notre [outil d'auto-évaluation](/outils/perplexity).
- **Forme-toi gratuitement** via notre [guide des formations IA gratuites](/guides/se-former-ia-gratuitement).
- **Utilise les aides** comme le CPF (France) ou les programmes "bridge AI" (UK).

### PME ou indépendant·e
- **Profite des subventions** pour adopter l'IA (ex : [France 2030](/guides/automatiser-travail-ia)).
- **Automatise tes processus** avec des outils comme [Jasper](/outils/jasper) ou [Notion AI](/outils/notion-ai).
- **Forme tes équipes** avec des modules courts (ex : [prompt engineering](/guides/prompt-engineering-debutant)).
...
- **Ciblez les métiers en tension** (ex : [infirmiers·ères](/metiers/infirmier-ia)).
