...
description: "L'étude Ipsos 2025 pour Amalgame dessine un marché du travail français en pleine bascule. On décrypte les vraies motivations, les freins invisibles, et ce que ça change pour les employeurs qui croient encore qu'un salaire suffit."
date: 2026-04-12
category: "etude"
impactLevel: 5
author: "Léa Moreau"
keyQuote:
  ...
  context: "Directeur général délégué Ipsos France, analyse du baromètre reconversion 2025"
tldr:
  - "Selon Ipsos pour Amalgame (2025), 47 % des actifs français envisagent une reconversion professionnelle dans les deux ans."
  - "Les trois moteurs principaux : quête de sens (62 %), rémunération jugée insuffisante (48 %), peur de voir son métier transformé par l'IA (31 %, en forte progression)."
  - "Le chiffre du désir de reconversion ne baisse pas depuis le Covid, il s'installe. Ce n'est plus un effet rebond, c'est une nouvelle norme."
  - "Seulement 14 % des candidats à la reconversion franchissent vraiment le pas dans les 12 mois. Le gouffre entre envie et action est le vrai sujet du marché du travail français."
sources:
  - title: "Baromètre Ipsos Amalgame 2025 sur la reconversion professionnelle"
...
**Tu es dans les 14 % qui passent à l'action.** Lis notre [guide reconversion IA complet](/guides/reconversion-ia-guide-complet) et le [guide CPF](/guides/financer-formation-ia-cpf). On y explique les pièges que 80 % des reconvertis rencontrent sans les avoir anticipés.
