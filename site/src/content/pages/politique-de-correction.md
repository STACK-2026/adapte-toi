...
**contact@adapte-toi.com** avec l'objet `CORRECTION` et, si possible :

1. l'URL de l'article concerné ;
2. l'élément contesté (cité tel quel ou repéré par un extrait) ;
3. la source primaire à confronter (lien, document, communiqué).
...
Adresse pour les droits de réponse : **contact@adapte-toi.com** avec l'objet `DROIT DE REPONSE`.
...
Toute question sur son application : **contact@adapte-toi.com**.
