---
title: "Étude Anthropic : Claude vs humains sur tâches cognitives"
description: "Étude Anthropic sur Claude vs humains : exposition observée par métier, chiffres clés du rapport et stratégies concrètes pour s'adapter en France."
...
<aside data-speakable="true" class="tldr" style="background:#f5f5f5;padding:16px;border-left:4px solid #6b46c1;margin:20px 0;"><strong>En bref :</strong> L'<strong>étude Anthropic</strong> sur Claude face aux travailleurs humains est la première à mesurer l'<em>exposition observée</em> des métiers à un assistant IA, et pas seulement leur exposition théorique. Le rapport montre un écart énorme entre potentiel et usage réel (94% des activités d'informatique théoriquement couvertes, 33% effectivement utilisées), un recul de 14% des embauches juniors dans les métiers très exposés et un noyau de 30% de professions sans exposition mesurable. Pour les actifs français, le message est clair : la menace est réelle sur certaines tâches, jamais sur l'intégralité d'un métier, et il existe une fenêtre nette pour devenir le pilote de l'IA plutôt que son substitut.</aside>
...
L'étude croise ces données avec la base [O*NET](https://www.onelook.com/?w=O*NET&ls=a) du département du Travail américain et avec les statistiques du [US Bureau of Labor Statistics](https://www.bls.gov/), pour rattacher chaque conversation à une profession formelle. Le résultat est un classement inédit des métiers selon leur exposition observée, c'est à dire la part de leurs tâches déjà déléguée à Claude par des utilisateurs réels.

Chez Adapte-toi, le média francophone qui décrypte la transformation du travail à l'ère de l'IA, on lit ce rapport comme un signal de marché, pas comme une prophétie. Si tu veux situer ton poste avant d'aller plus loin, commence par [Métiers menacés par l'IA : Top 15 des professions à risque](/blog/metiers-menaces-ia-top-15-professions-risque/), puis reviens ici pour la lecture détaillée.
...
Cette distinction recoupe les analyses macroéconomiques du [Fonds monétaire international sur la transformation de 40% des emplois mondiaux](/blog/rapport-fmi-40-emplois-mondiaux-transformes-ia/) : l'exposition n'est pas la destruction, et le temps d'adaptation se compte en années, pas en trimestres.

## Quels métiers sont les plus exposés à Claude selon l'étude Anthropic

Le rapport identifie un peloton de tête très concentré sur les activités cognitives standardisées, qui rejoint largement le classement des [40% d'emplois exposés du rapport PwC](/blog/rapport-pwc-40-emplois-menaces-ia-2030/) et les analyses sectorielles du [rapport McKinsey 2026 sur l'impact de l'IA en France](/blog/rapport-mckinsey-2026-impact-ia-emploi-francais/).
...
Mais le pattern est cohérent avec d'autres données publiques sur le développement logiciel. C'est le secteur où l'adoption va le plus vite, où les modèles sont les plus matures et où la mesure du gain est la plus directe (lignes de code livrées, tickets résolus). Pour creuser la transformation concrète du métier, lis [Développeur devenu expert IA : parcours de reconversion](/blog/developpeur-expert-ia-parcours-reconversion/) et la fiche complète du métier [développeur IA](/metiers/developpeur-ia/).
...
L'hypothèse : les tâches confiées historiquement aux juniors (production de brouillons, recherches préliminaires, premières analyses) sont précisément celles que l'IA absorbe le mieux. Les employeurs reportent leur recrutement et concentrent les missions restantes sur des profils plus expérimentés. Si elle se confirme et se généralise, cette dynamique transforme l'entrée dans la vie active autant que la sortie. Elle rejoint les inquiétudes documentées dans [l'étude de l'OCDE sur l'IA et l'emploi en Europe](/blog/etude-ocde-ia-va-detruire-emploi-europe/).
...
**Limite de couverture.** L'étude mesure l'usage de Claude, qui reste minoritaire face à ChatGPT dans le grand public. La comparaison fine [Claude vs ChatGPT](/guides/claude-vs-chatgpt/) montre que les deux outils ne couvrent pas exactement les mêmes usages, et la fiche [outil Claude](/outils/claude/) précise dans quels contextes le modèle d'Anthropic excelle (texte long, raisonnement nuancé, code).

Pour transposer le rapport au cas français, croise systématiquement ses chiffres avec deux sources nationales : les enquêtes Besoins en main-d'œuvre publiées par [France Travail](https://www.francetravail.fr/) et les projections macroéconomiques rassemblées dans le [Future of Jobs Report 2025 du Forum économique mondial](https://www.weforum.org/publications/the-future-of-jobs-report-2025/), qui dispose d'un volet France. La triangulation est ce qui fait la différence entre une lecture sérieuse et un titre racoleur.
...
1. **Auditer tes propres tâches.** Pendant deux semaines, note chaque livrable produit et estime, en pourcentage, ce qu'un assistant comme Claude pourrait écrire à ta place avec un bon prompt. C'est ton exposition observée personnelle.
2. **Apprendre à piloter au moins un modèle généraliste.** Choisis Claude ou ChatGPT, et investis vingt heures de pratique réelle, pas de tutoriels passifs. Voir la fiche [outil Claude](/outils/claude/) et le [comparatif Claude vs ChatGPT](/guides/claude-vs-chatgpt/) pour choisir.
3. **Documenter trois cas d'usage IA dans ton poste actuel.** Présente-les à ton manager ou à ton client. Tu deviens immédiatement la personne qui apporte la solution, pas celle qui subit la transformation.
4. **Identifier ton irréductible.** Quelle part de ton métier dépend de jugement, de relation, de responsabilité ou d'expertise sectorielle que l'IA ne peut pas porter à ta place ? C'est sur cette part que tu construis ta sécurité.
5. **Construire une preuve publique.** Un retour d'expérience LinkedIn, un mini portfolio, un projet open source. Le marché 2026 recrute sur les réalisations IA, pas sur les certificats.
...
👉 **Découvre comment l'application Adapte-toi croise les rapports d'Anthropic, McKinsey et France Travail pour personnaliser ton plan de reconversion ou d'augmentation IA.**

---

## Sources

1. Anthropic. « Labor market impacts of AI : a new measure and early evidence ». [Page de recherche officielle](https://www.anthropic.com/research).
...
3. US Bureau of Labor Statistics. « Occupational Employment and Wage Statistics » (2025). [Site officiel](https://www.bls.gov/).
4. France Travail. « Enquête Besoins en main-d'œuvre et études sur l'IA » (2026). [Site officiel](https://www.francetravail.fr/).
...
- [Rapport FMI : 40% des emplois mondiaux transformés par l'IA](https://adapte-toi.com/blog/rapport-fmi-40-emplois-mondiaux-transformes-ia)
