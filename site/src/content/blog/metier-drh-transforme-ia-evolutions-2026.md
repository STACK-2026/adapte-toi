...
1. **Auditer avant de déployer** : cartographie les tâches concernées, identifie les données utilisées, évalue les risques de biais
2. **Consulter le CSE** : l'introduction de systèmes IA de surveillance ou d'évaluation est soumise à information-consultation préalable
3. **Former les managers** : un manager qui ne comprend pas les limites de l'outil qu'il utilise prend des décisions biaisées avec un sentiment de légitimité algorithmique
4. **Garantir le contrôle humain** : aucune décision RH significative (embauche, licenciement, promotion) ne peut reposer uniquement sur une décision algorithmique
5. **Documenter et tracer** : qui a accès aux données, pourquoi, avec quelle durée de conservation
6. **Évaluer régulièrement** : réalise des audits de biais trimestriels sur les outils déployés
...
- [Métier de journaliste face à l'IA : Analyse complète](https://adapte-toi.com/blog/metier-journaliste-face-ia-analyse-complete)
