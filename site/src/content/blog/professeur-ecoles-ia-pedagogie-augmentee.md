...
imageAlt: "Enseignante en classe de primaire accompagnant des élèves sur une tablette numérique"
---
...
Oui, c'est un cadre national de référence. Le ministère de l'Éducation nationale a publié le 14 juin 2025 la version définitive du [cadre d'usage de l'intelligence artificielle en éducation](https://www.education.gouv.fr/publication-du-cadre-d-usage-de-l-intelligence-artificielle-en-education-462936), annoncé en février 2025. C'est le document de référence qui fixe ce qui est permis, encadré ou interdit à chaque niveau de la scolarité.
...
**3. Protection des données et fraude.** Le cadre encadre strictement les données personnelles des élèves, qui ne doivent pas être saisies dans des services non maîtrisés. La [CNIL](https://www.cnil.fr/fr/intelligence-artificielle) accompagne ces usages avec des recommandations dédiées. Côté collège, tout recours à l'IA générative pour réaliser un devoir sans travail personnel d'appropriation est considéré comme une fraude, un principe que les enseignants du primaire ont intérêt à connaître pour préparer leurs élèves à la suite.

Pour aller plus loin sur les usages institutionnels, le ministère recense ses ressources sur [éduscol, les intelligences artificielles et leurs usages en éducation](https://eduscol.education.gouv.fr/6702/les-intelligences-artificielles-et-leurs-usages-en-education).
...
Le ministère a également mis en place un [Observatoire national des pratiques pédagogiques avec l'intelligence artificielle](https://eduscol.education.gouv.fr/6884/observatoire-national-des-pratiques-pedagogiques-avec-l-intelligence-artificielle), preuve que l'institution suit de près la généralisation de ces usages plutôt que de les laisser au hasard.

Au-delà des outils officiels, beaucoup de professeurs des écoles s'appuient sur des assistants génératifs pour leur travail de préparation. Pour un panorama testé et adapté au métier, consulte notre [guide des outils IA pour les enseignants](/guides/outils-ia-pour-enseignant/), qui détaille les usages concrets et les limites de chaque solution.
...
C'est exactement pour cette raison que la fiche métier détaillée de l'[enseignant face à l'IA](/metiers/enseignant-ia/) classe ce métier comme augmenté, pas menacé. L'IA déplace la valeur du professeur vers ce qui est le plus humain dans son travail.
...
Si tu envisages, à plus long terme, de faire de cette expertise un vrai projet professionnel, le parcours de [professeur reconverti en formateur IA](/blog/professeur-reconverti-formateur-ia-histoire/) montre concrètement comment des enseignants transforment cette compétence en nouvelle voie.
...
- Ministère de l'Éducation nationale, Publication du cadre d'usage de l'intelligence artificielle en éducation, juin 2025 - [education.gouv.fr](https://www.education.gouv.fr/publication-du-cadre-d-usage-de-l-intelligence-artificielle-en-education-462936)
- éduscol, L'intelligence artificielle pour accompagner les apprentissages des fondamentaux au cycle 2 (P2IA) - [eduscol.education.gouv.fr](https://eduscol.education.gouv.fr/6714/l-intelligence-artificielle-pour-accompagner-les-apprentissages-des-fondamentaux-au-cycle-2)
- éduscol, Observatoire national des pratiques pédagogiques avec l'intelligence artificielle - [eduscol.education.gouv.fr](https://eduscol.education.gouv.fr/6884/observatoire-national-des-pratiques-pedagogiques-avec-l-intelligence-artificielle)
- éduscol, Les intelligences artificielles et leurs usages en éducation - [eduscol.education.gouv.fr](https://eduscol.education.gouv.fr/6702/les-intelligences-artificielles-et-leurs-usages-en-education)
- CNIL, Intelligence artificielle, recommandations et fiches pratiques - [cnil.fr](https://www.cnil.fr/fr/intelligence-artificielle)
- UNESCO, Guidance for Generative AI in Education and Research, 2023 - [unesco.org](https://www.unesco.org/en/articles/unesco-governments-must-quickly-regulate-generative-ai-schools)
...
Adapte-toi, le média indépendant sur la reconversion à l'ère de l'IA, suit cette transformation métier par métier. Explore notre [dossier complet sur les métiers impactés par l'IA](/metiers/) pour aller plus loin, avec des fiches détaillées, des données de marché et des plans d'action secteur par secteur.

---

## Articles similaires

- [Enseignant face à l'IA : fiche métier complète](https://adapte-toi.com/metiers/enseignant-ia/)
- [Professeur reconverti en formateur IA : mon témoignage](https://adapte-toi.com/blog/professeur-reconverti-formateur-ia-histoire/)
