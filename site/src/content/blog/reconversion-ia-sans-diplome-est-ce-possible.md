...
imageAlt: "Personne travaillant sur un ordinateur portable et prenant des notes pour se former en autodidacte"
---
...
Les certifications ciblées viennent ensuite. Une certification en prompt engineering, en gestion de projet ou en intégration d'outils IA donne un signal concret aux recruteurs. Plusieurs sont reconnues et finançables. Pour t'y retrouver, notre panorama des [meilleures certifications IA reconnues](/blog/certification-ia-top-10-diplomes-reconnus/) compare les options selon ton objectif.
...
Le compte personnel de formation, le CPF, est le levier le plus connu. Tes droits, consultables et mobilisables directement sur la plateforme Mon Compte Formation, peuvent couvrir tout ou partie d'une formation éligible. C'est le premier réflexe à avoir. Notre [guide pour financer une formation IA avec le CPF](/blog/cpf-formation-ia-comment-financer-reconversion/) détaille les démarches pas à pas.
...
Pour identifier le métier d'IA le plus aligné avec ton profil, notre [test pour trouver le métier IA qui te correspond](/blog/test-personnalite-quel-metier-ia-vous-correspond/) est un bon point de départ. Et si tu envisages l'indépendance plutôt que le salariat, notre [guide pour devenir consultant IA freelance](/blog/devenir-consultant-ia-freelance-guide-complet-2026/) détaille le modèle économique.
...
- Coursera, cours "L'IA pour tous" par Andrew Ng - [coursera.org](https://www.coursera.org/learn/ai-for-everyone)
...
- France Num, ressources publiques sur la transformation numérique des entreprises - [francenum.gouv.fr](https://www.francenum.gouv.fr/)
- OCDE, travaux sur l'intelligence artificielle et les marchés du travail - [oecd.org](https://www.oecd.org/en/topics/artificial-intelligence.html)
- PwC, AI Jobs Barometer sur l'évolution de la demande de compétences - [pwc.com](https://www.pwc.com/gx/en/issues/artificial-intelligence/ai-jobs-barometer.html)
- CNIL, recommandations sur l'intelligence artificielle et la protection des données - [cnil.fr](https://www.cnil.fr/)
...
- [Bilan de compétences IA : le guide pour se reconvertir](https://adapte-toi.com/blog/bilan-competences-ia-guide-se-reconvertir)
